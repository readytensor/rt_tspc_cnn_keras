# CNN Time Step Classifier in Tensorflow

CNN Time Step Classification Model in Tensorflow as per Ready Tensor specifications.
...
- A **CNN Time Step Classification n** model built using **Tensorflow**
